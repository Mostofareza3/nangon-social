...
const Project = ({ type, title, img, link, github }) => {
  return (
    <article className="w-full flex items-center rounded-2xl border border-solid border-dark bg-light p-6 relative flex-col">
      <Link
        href={link}
        target="_blank"
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        >
          <h2
            className="my-2 w-full text-left text-2xl font-bold hover:underline underline-offset-2
        "
          >
            {title}
          </h2>
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Reza | Projects Page</title>
